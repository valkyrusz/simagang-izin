				...
				<tbody>
					...
					?>	
						<tr>
							...
							<td><img src="<?php echo $row["foto"]?>" alt="Foto Mahasiswa" class="img-fluid" style="width:50px; height:50px; object-fit:cover;" onerror="this.onerror=null; this.src='foto/default.png';"></td>
							<!-- Menggunakan onerror untuk menampilkan gambar default jika gambar tidak ditemukan -->
